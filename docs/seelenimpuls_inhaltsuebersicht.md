# Seelenimpuls App: Inhaltsübersicht
Stand: 25. April 2026
...
- [Teil 1: Freie Inhalte](#teil-1-freie-inhalte)
  - Tagesimpulse (14 DE / 14 EN)
  - Atemübungen (6 Techniken)
- [Teil 2: Situationen](#teil-2-situationen) (11 Situationen × 7 Module)
...
- [Teil 3: Geführte Meditationen](#teil-3-geführte-meditationen)
- [Teil 4: Affirmationskarten](#teil-4-affirmationskarten) (11 Karten)
- [Teil 5: Arbeitsblätter](#teil-5-arbeitsblätter) (11 Arbeitsblätter)
- [Teil 6: Klangwelten](#teil-6-klangwelten) (11 Klangwelten)
- [Teil 7: UI-Texte](#teil-7-ui-texte)
- [Teil 8: Auffälligkeiten](#teil-8-auffälligkeiten)

---

## Teil 1: Freie Inhalte

### Tagesimpulse

Täglich rotierend (tagesbasiert), 14 Impulse pro Sprache.

**Deutsch:**

1. Atme tief ein. Du darfst gehalten sein.
2. Du darfst langsam sein.
3. Dein Herz kennt den Weg.
4. Alles darf leicht werden.
5. Du darfst in Sicherheit ankommen.
6. Dieser Atemzug trägt dich.
7. Du bist genug, genau so.
8. Ruhe ist kein Luxus. Sie ist dein Recht.
9. Vertrauen darf wachsen.
10. Du bist nicht allein.
11. Dieser Moment gehört dir.
12. Sanftheit beginnt bei dir selbst.
13. Alles findet seinen Weg.
14. Du darfst ankommen.

**Englisch:**

1. Breathe deeply in. You may be held.
2. You may be slow.
3. Your heart knows the way.
4. Everything may become light.
5. You may arrive in safety.
6. This breath holds you.
7. You are enough, exactly as you are.
8. Rest is not a luxury. It is your right.
9. Trust may grow.
10. You are not alone.
11. This moment belongs to you.
12. Gentleness begins with yourself.
13. Everything finds its way.
14. You may arrive.
...
Gesamtdauer je Übung: 3 Minuten. Der Nutzer tippt auf den Atemkreis, um zur nächsten Phase zu springen.

#### Atemübung 1: Kohärentes Atmen / Coherent Breathing

**Takt:** 5 Sek. ein · 5 Sek. aus

**Beschreibung (DE):** Beruhigt das Nervensystem und fördert die Herzratenvariabilität. Ideal als tägliche Praxis.

**Beschreibung (EN):** Calms the nervous system and promotes heart rate variability. Ideal as a daily practice.

Phasen: EIN (5 Sek.) → AUS (5 Sek.) → Wiederholung

#### Atemübung 2: 4-7-8 Atmung / 4-7-8 Breathing

**Takt:** 4 Sek. ein · 7 Sek. halten · 8 Sek. aus

**Beschreibung (DE):** Beruhigt das Nervensystem schnell. Hilft bei Angst, Stress und beim Einschlafen.

**Beschreibung (EN):** Quickly calms the nervous system. Great for anxiety, stress and falling asleep.

Phasen: EIN (4 Sek.) → HALTEN (7 Sek.) → AUS (8 Sek.) → Wiederholung

#### Atemübung 3: Box Breathing

**Takt:** Je 4 Sek. ein · halten · aus · halten

**Beschreibung (DE):** Stärkt Fokus und innere Ruhe. Wird von Spitzensportlern und Einsatzkräften weltweit genutzt.

**Beschreibung (EN):** Strengthens focus and inner calm. Used by elite athletes and first responders worldwide.

Phasen: EIN (4 Sek.) → HALTEN (4 Sek.) → AUS (4 Sek.) → HALTEN (4 Sek.) → Wiederholung

#### Atemübung 4: Physiologisches Seufzen / Physiological Sigh

**Takt:** Doppeltes Einatmen + langer Ausatem

**Beschreibung (DE):** Laut Neurowissenschaften der schnellste Weg zur Entspannung. Tief einatmen, kurz nachsaugen, dann so lange wie möglich ausatmen.

**Beschreibung (EN):** According to neuroscience, the fastest route to calm. Deep inhale, brief top-up, then exhale as long as possible.

Phasen: EIN (4 Sek.) → +EIN (2 Sek.) → AUS (8 Sek.) → Wiederholung

#### Atemübung 5: 2:1 Atmung / 2:1 Breathing

**Takt:** 4 Sek. ein · 8 Sek. aus

**Beschreibung (DE):** Aktiviert den Parasympathikus (Ruhe & Erholung). Ideal für tiefe Entspannung nach einem langen Tag.

**Beschreibung (EN):** Activates the parasympathetic nervous system (rest & digest). Ideal for deep relaxation after a long day.

Phasen: EIN (4 Sek.) → AUS (8 Sek.) → Wiederholung

#### Atemübung 6: Vollständiges Ausatmen / Complete Exhale

**Takt:** 4 · 5 · 2,5 · 2 Sek.

**Beschreibung (DE):** Reinigt die Lunge komplett. Atme aus – und wenn du denkst, du bist fertig, schiebe die allerletzten Reste heraus.

**Beschreibung (EN):** Fully cleanses the lungs. Exhale – and when you think you're done, push out the very last bit of air.

Phasen: EIN (4 Sek.) → AUS (5 Sek.) → LEER/PUSH (2,5 Sek.) → PAUSE/HOLD (2 Sek.) → Wiederholung
