...
window.SITUATIONS[3] = {
  ...
  ritual: [
    ...
    "Spüre Stabilität unter dir.",
    "Atme ruhig ein.",
    "Atme langsam aus.",
    "Nimm wahr, wo dein Körper festhält.",
    "Lege eine Hand auf diese Stelle.",
    "Mit jedem Ausatmen darf sich dort etwas lösen.",
    "Sage innerlich: „Ich werde weicher.“",
    "Bleibe noch drei ruhige Atemzüge dabei."
  ],

  songFile_de: "audio/meditation-situation-3-de.mp3",
  songFile_en: "audio/meditation-situation-3-en.mp3",
