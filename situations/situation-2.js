...
window.SITUATIONS[2] = {
  ...
  ritual: [
    ...
    "Spüre dein Gewicht und den Halt unter dir.",
    "Atme ruhig ein.",
    "Atme langsam aus.",
    "Spüre, wo sich Druck oder Enge zeigt.",
    "Lege eine Hand auf diese Stelle.",
    "Mit jedem Ausatmen darf dort mehr Weite entstehen.",
    "Sage innerlich: „Jetzt entsteht Entlastung in mir.“",
    "Bleibe noch drei ruhige Atemzüge dabei."
  ],

  songFile_de: "audio/meditation-situation-2-de.mp3",
  songFile_en: "audio/meditation-situation-2-en.mp3",
